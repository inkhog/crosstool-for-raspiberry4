...
enum opt_code
{
  ...
  OPT_mabi_ = 1192,                          /* -mabi= */
  OPT_mandroid = 1193,                       /* -mandroid */
  OPT_march_ = 1194,                         /* -march= */
  OPT_mbig_endian = 1195,                    /* -mbig-endian */
  OPT_mbionic = 1196,                        /* -mbionic */
  OPT_mcmodel_ = 1197,                       /* -mcmodel= */
  OPT_mcpu_ = 1198,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1199,         /* -mfix-cortex-a53-835769 */
  OPT_mfix_cortex_a53_843419 = 1200,         /* -mfix-cortex-a53-843419 */
  OPT_mgeneral_regs_only = 1201,             /* -mgeneral-regs-only */
  OPT_mglibc = 1202,                         /* -mglibc */
  OPT_mlittle_endian = 1203,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1204,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1205,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1206,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1207,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1208,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1209,               /* -moutline-atomics */
  OPT_moverride_ = 1210,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1211,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1212,          /* -msign-return-address= */
  OPT_mstrict_align = 1213,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1214,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1215,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1216,                     /* -mtls-size= */
  OPT_mtune_ = 1217,                         /* -mtune= */
  OPT_muclibc = 1218,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1219,             /* -mverbose-cost-dump */
  OPT_n = 1220,                              /* -n */
  OPT_no_canonical_prefixes = 1221,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1222,              /* -no-integrated-cpp */
  OPT_no_pie = 1223,                         /* -no-pie */
  OPT_nocpp = 1224,                          /* -nocpp */
  OPT_nodefaultlibs = 1225,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1226,                   /* -nostartfiles */
  OPT_nostdinc = 1227,                       /* -nostdinc */
  OPT_nostdinc__ = 1228,                     /* -nostdinc++ */
  OPT_nostdlib = 1229,                       /* -nostdlib */
  OPT_o = 1230,                              /* -o */
  OPT_p = 1231,                              /* -p */
  OPT_pass_exit_codes = 1232,                /* -pass-exit-codes */
  /* OPT_pedantic = 1233, */                 /* -pedantic */
  OPT_pedantic_errors = 1234,                /* -pedantic-errors */
  OPT_pg = 1235,                             /* -pg */
  OPT_pie = 1236,                            /* -pie */
  OPT_pipe = 1237,                           /* -pipe */
  OPT_posix = 1238,                          /* -posix */
  OPT_print_file_name_ = 1239,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1240,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1241,          /* -print-multi-directory */
  OPT_print_multi_lib = 1242,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1243,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1244,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1245,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1246,               /* -print-prog-name= */
  OPT_print_search_dirs = 1247,              /* -print-search-dirs */
  OPT_print_sysroot = 1248,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1249,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1250,                        /* -profile */
  OPT_pthread = 1251,                        /* -pthread */
  OPT_quiet = 1252,                          /* -quiet */
  OPT_r = 1253,                              /* -r */
  OPT_rdynamic = 1254,                       /* -rdynamic */
  OPT_remap = 1255,                          /* -remap */
  OPT_s = 1256,                              /* -s */
  OPT_save_temps = 1257,                     /* -save-temps */
  OPT_save_temps_ = 1258,                    /* -save-temps= */
  OPT_shared = 1259,                         /* -shared */
  OPT_shared_libgcc = 1260,                  /* -shared-libgcc */
  /* OPT_specs = 1261, */                    /* -specs */
  OPT_specs_ = 1262,                         /* -specs= */
  OPT_static = 1263,                         /* -static */
  OPT_static_libasan = 1264,                 /* -static-libasan */
  OPT_static_libgcc = 1265,                  /* -static-libgcc */
  OPT_static_libgfortran = 1266,             /* -static-libgfortran */
  OPT_static_libgo = 1267,                   /* -static-libgo */
  OPT_static_liblsan = 1268,                 /* -static-liblsan */
  OPT_static_libmpx = 1269,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1270,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1271,               /* -static-libstdc++ */
  OPT_static_libtsan = 1272,                 /* -static-libtsan */
  OPT_static_libubsan = 1273,                /* -static-libubsan */
  OPT_static_pie = 1274,                     /* -static-pie */
  /* OPT_std_c__03 = 1275, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1276, */                /* -std=c++0x */
  OPT_std_c__11 = 1277,                      /* -std=c++11 */
  OPT_std_c__14 = 1278,                      /* -std=c++14 */
  OPT_std_c__17 = 1279,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1280, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1281, */                /* -std=c++1z */
  OPT_std_c__2a = 1282,                      /* -std=c++2a */
  OPT_std_c__98 = 1283,                      /* -std=c++98 */
  OPT_std_c11 = 1284,                        /* -std=c11 */
  OPT_std_c17 = 1285,                        /* -std=c17 */
  /* OPT_std_c18 = 1286, */                  /* -std=c18 */
  /* OPT_std_c1x = 1287, */                  /* -std=c1x */
  /* OPT_std_c89 = 1288, */                  /* -std=c89 */
  OPT_std_c90 = 1289,                        /* -std=c90 */
  OPT_std_c99 = 1290,                        /* -std=c99 */
  /* OPT_std_c9x = 1291, */                  /* -std=c9x */
  OPT_std_f2003 = 1292,                      /* -std=f2003 */
  OPT_std_f2008 = 1293,                      /* -std=f2008 */
  OPT_std_f2008ts = 1294,                    /* -std=f2008ts */
  OPT_std_f2018 = 1295,                      /* -std=f2018 */
  OPT_std_f95 = 1296,                        /* -std=f95 */
  OPT_std_gnu = 1297,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1298, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1299, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1300,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1301,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1302,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1303, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1304, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1305,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1306,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1307,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1308,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1309, */                /* -std=gnu18 */
  ...
  /* OPT_std_iso9899_2017 = 1320, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1321, */         /* -std=iso9899:2018 */
