...
enum opt_code
{
  ...
  OPT_mharden_sls_ = 1286,                   /* -mharden-sls= */
  OPT_mlittle_endian = 1287,                 /* -mlittle-endian */
  OPT_mlow_precision_div = 1288,             /* -mlow-precision-div */
  OPT_mlow_precision_recip_sqrt = 1289,      /* -mlow-precision-recip-sqrt */
  OPT_mlow_precision_sqrt = 1290,            /* -mlow-precision-sqrt */
  OPT_mmusl = 1291,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1292,       /* -momit-leaf-frame-pointer */
  OPT_moutline_atomics = 1293,               /* -moutline-atomics */
  OPT_moverride_ = 1294,                     /* -moverride= */
  OPT_mpc_relative_literal_loads = 1295,     /* -mpc-relative-literal-loads */
  OPT_msign_return_address_ = 1296,          /* -msign-return-address= */
  OPT_mstack_protector_guard_offset_ = 1297, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1298,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1299,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1300,                  /* -mstrict-align */
  OPT_msve_vector_bits_ = 1301,              /* -msve-vector-bits= */
  OPT_mtls_dialect_ = 1302,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1303,                     /* -mtls-size= */
  OPT_mtrack_speculation = 1304,             /* -mtrack-speculation */
  OPT_mtune_ = 1305,                         /* -mtune= */
  OPT_muclibc = 1306,                        /* -muclibc */
  OPT_mverbose_cost_dump = 1307,             /* -mverbose-cost-dump */
  OPT_n = 1308,                              /* -n */
  OPT_no_canonical_prefixes = 1309,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1310,              /* -no-integrated-cpp */
  OPT_no_pie = 1311,                         /* -no-pie */
  OPT_nocpp = 1312,                          /* -nocpp */
  OPT_nodefaultlibs = 1313,                  /* -nodefaultlibs */
  OPT_nolibc = 1314,                         /* -nolibc */
  OPT_nophoboslib = 1315,                    /* -nophoboslib */
  OPT_nostartfiles = 1316,                   /* -nostartfiles */
  OPT_nostdinc = 1317,                       /* -nostdinc */
  OPT_nostdinc__ = 1318,                     /* -nostdinc++ */
  OPT_nostdlib = 1319,                       /* -nostdlib */
  OPT_o = 1320,                              /* -o */
  OPT_p = 1321,                              /* -p */
  OPT_pass_exit_codes = 1322,                /* -pass-exit-codes */
  /* OPT_pedantic = 1323, */                 /* -pedantic */
  OPT_pedantic_errors = 1324,                /* -pedantic-errors */
  OPT_pg = 1325,                             /* -pg */
  OPT_pie = 1326,                            /* -pie */
  OPT_pipe = 1327,                           /* -pipe */
  OPT_posix = 1328,                          /* -posix */
  OPT_print_file_name_ = 1329,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1330,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1331,          /* -print-multi-directory */
  OPT_print_multi_lib = 1332,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1333,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1334,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1335,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1336,               /* -print-prog-name= */
  OPT_print_search_dirs = 1337,              /* -print-search-dirs */
  OPT_print_sysroot = 1338,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1339,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1340,                        /* -profile */
  OPT_pthread = 1341,                        /* -pthread */
  OPT_quiet = 1342,                          /* -quiet */
  OPT_r = 1343,                              /* -r */
  OPT_rdynamic = 1344,                       /* -rdynamic */
  OPT_remap = 1345,                          /* -remap */
  OPT_s = 1346,                              /* -s */
  OPT_save_temps = 1347,                     /* -save-temps */
  OPT_save_temps_ = 1348,                    /* -save-temps= */
  OPT_shared = 1349,                         /* -shared */
  OPT_shared_libgcc = 1350,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1351,               /* -shared-libphobos */
  ...
  OPT_static_libphobos = 1362,               /* -static-libphobos */
  OPT_static_libstdc__ = 1363,               /* -static-libstdc++ */
  OPT_static_libtsan = 1364,                 /* -static-libtsan */
  OPT_static_libubsan = 1365,                /* -static-libubsan */
  OPT_static_pie = 1366,                     /* -static-pie */
  /* OPT_std_c__03 = 1367, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1368, */                /* -std=c++0x */
  OPT_std_c__11 = 1369,                      /* -std=c++11 */
  OPT_std_c__14 = 1370,                      /* -std=c++14 */
  OPT_std_c__17 = 1371,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1372, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1373, */                /* -std=c++1z */
  OPT_std_c__2a = 1374,                      /* -std=c++2a */
  OPT_std_c__98 = 1375,                      /* -std=c++98 */
  OPT_std_c11 = 1376,                        /* -std=c11 */
  OPT_std_c17 = 1377,                        /* -std=c17 */
  /* OPT_std_c18 = 1378, */                  /* -std=c18 */
  /* OPT_std_c1x = 1379, */                  /* -std=c1x */
  OPT_std_c2x = 1380,                        /* -std=c2x */
  /* OPT_std_c89 = 1381, */                  /* -std=c89 */
  OPT_std_c90 = 1382,                        /* -std=c90 */
  OPT_std_c99 = 1383,                        /* -std=c99 */
  /* OPT_std_c9x = 1384, */                  /* -std=c9x */
  OPT_std_f2003 = 1385,                      /* -std=f2003 */
  OPT_std_f2008 = 1386,                      /* -std=f2008 */
  OPT_std_f2008ts = 1387,                    /* -std=f2008ts */
  OPT_std_f2018 = 1388,                      /* -std=f2018 */
  OPT_std_f95 = 1389,                        /* -std=f95 */
  OPT_std_gnu = 1390,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1391, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1392, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1393,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1394,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1395,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1396, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1397, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1398,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1399,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1400,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1401,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1402, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1403, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1404,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1405, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1406,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1407,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1408, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1409, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1410,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1411, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1412, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1413, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1414, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1415, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1416,                     /* -std=legacy */
  OPT_symbolic = 1417,                       /* -symbolic */
  OPT_t = 1418,                              /* -t */
  OPT_time = 1419,                           /* -time */
  OPT_time_ = 1420,                          /* -time= */
  OPT_tno_android_cc = 1421,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1422,                 /* -tno-android-ld */
  OPT_traditional = 1423,                    /* -traditional */
  OPT_traditional_cpp = 1424,                /* -traditional-cpp */
  OPT_trigraphs = 1425,                      /* -trigraphs */
  OPT_u = 1426,                              /* -u */
  OPT_undef = 1427,                          /* -undef */
  OPT_v = 1428,                              /* -v */
  OPT_version = 1429,                        /* -version */
  OPT_w = 1430,                              /* -w */
  OPT_wrapper = 1431,                        /* -wrapper */
  OPT_x = 1432,                              /* -x */
  OPT_z = 1433,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
